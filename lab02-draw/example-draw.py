...
while (True):
    ...
    # Draw the engine
    arcade.draw_rectangle_filled(posX + 600, 120, 140, 70, arcade.color.GRAY)
    arcade.draw_rectangle_filled(posX + 590, 105, 90, 40, arcade.color.BLACK)

    # Draw the smoke stack
    arcade.draw_rectangle_filled(580, 175, 10, 40, arcade.color.BLACK)

    # Back wheel
    arcade.draw_circle_filled(posX + 490, 110, 50, arcade.color.BLACK)
    arcade.draw_circle_filled(posX + 490, 110, 45, arcade.color.BLACK_OLIVE)
    arcade.draw_circle_filled(posX + 490, 110, 35, arcade.color.OLD_LACE)
    arcade.draw_circle_filled(posX + 490, 110, 10, arcade.color.RED)

    # Front wheel
    arcade.draw_circle_filled(posX + 650, 90, 30, arcade.color.BLACK)
    arcade.draw_circle_filled(posX + 650, 90, 25, arcade.color.BLACK_OLIVE)
    arcade.draw_circle_filled(posX + 650, 90, 18, arcade.color.OLD_LACE)
    arcade.draw_circle_filled(posX + 650, 90, 5, arcade.color.RED)
